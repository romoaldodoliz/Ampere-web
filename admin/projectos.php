...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO nossosprojectos (admin_id, numero, tipo_servico) VALUES ('$admin_id', '$numero', '$tiposervico')";
...
$sql = "SELECT * FROM nossosprojectos";
$result = mysqli_query($conn, $sql);
...
<html lang="en">
    <head>
        ...
        <link href="css/dbcard.css" rel="stylesheet" />
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4">Projectos da Ampere</h1>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <strong>Número de Satisfação:</strong> <?php echo $row['numero']; ?>
                            </div>
                            <div class="col-md-6">
                                <strong>Tipo de Serviço:</strong> <?php echo $row['tipo_servico']; ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="numero" class="form-label">Número de Satisfaçāo:</label>
                    <input type="number" class="form-control" id="numero" name="numero" required>
                </div>
                <div class="mb-3">
                    <label for="tipo_servico" class="form-label">Tipo de Serviço:</label>
                    <input type="text" class="form-control" id="tipo_servico" name="tipo_servico" required>                </div>
