...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Painel de Administrador do Site Amperes" />
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <!-- fim dos menu sidebar -->
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Painel de Admin</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"> 
								Welcome <b> <?php echo  $_SESSION['username'];?> </b> Dashboard
							</li>
                        </ol>
                        <div class="row">
				...
				<!-- rodape do painel de administrador -->
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Romoaldo Doliz</div>
                            <div>
